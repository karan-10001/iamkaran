...
const SCENARIOS = {
  halliburton: {
    ...
    featureTitle: 'Wellbore Telemetry Stream',
    ...
    logs: [
      ...
      'Page: Navigated to https://telemetry.halliburton.com/streams/WB-88201',
  ...
  mercedes: {
    ...
    logs: [
      ...
      'Environment: Health check https://staging.mercedes-benz.com/health returned 200',
